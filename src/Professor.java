public class Professor {
    ...
    public boolean verificarProfessor(Integer codigoProfessorNovo){
       Integer codigoProfessor = this.getCodigoProfessor();
        if (codigoProfessor.equals(codigoProfessorNovo)){
            return true;
        }
        else{
        return false;
